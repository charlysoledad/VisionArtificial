...
eyes_cascade        = cv2.CascadeClassifier('opencv-master/third-party/frontalEyes35x16.xml')
nose_cascade        = cv2.CascadeClassifier('opencv-master/third-party/Nose18x15.xml')
